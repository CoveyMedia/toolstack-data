({
    ...
    VM_MODE_NATIVE_LABEL: "Run a single VM only and hide SecureView",
    VM_MODE_NOT_NATIVE_LABEL: "Run multiple VMs and show SecureView",
    TELL_ME_MORE: "Tell me more",
    VM_MODE_NATIVE_TOOLTIP: "This mode makes a single VM run like a native OS. Settings are simplified because networking, power settings, and USB devices are controlled from within the OS.<br/><br/>With this mode, the only way to return to SecureView is by using the keyboard shortcut CTRL + 0.",
    VM_MODE_NOT_NATIVE_TOOLTIP: "This mode lets you run multiple VMs at the same time. Settings, such as networking and assigning USB devices and 3D graphics, are accessed from SecureView.<br/><br/>With this mode you can use the switcher bar to switch between VMs or go back to SecureView.",
    XENCLIENT_ACCESS_TIP: "To access SecureView from the VM, press CTRL + 0",
    ...
    ON: "On",
    OFF: "Off",
    XENCLIENT_VERSION_LABEL: "SecureView Version:",
    XENCLIENT_BUILD_LABEL: "SecureView Build:",
    ...
    UPDATE_TOOLTIP: "Your administrator should provide the URL to update SecureView",
    ...
    STATUS_SERVER: "Please refer to the Troubleshooting chapter of the SecureView user guide for help downloading your status reports.",
    ...
    CANNOT_UPGRADE: "Installed SecureView version: {0}\nLatest SecureView version: {1}\n\nIt is not possible to update to this version of SecureView.",
    CAN_UPGRADE: "Installed SecureView version: {0}\nLatest SecureView version: {1}\n\nA newer version of SecureView was detected, would you like to download this update?\n\nPlease refer to the documentation for more information about how this can affect your system.",
    UP_TO_DATE: "Installed SecureView version: {0}\nLatest SecureView version: {1}\n\nYou are running the latest version of SecureView, but you may refresh it by downloading and applying it again.\n\nPlease refer to the documentation for more information about how this can affect your system.",
    ...
    LANGUAGE_US: "English",
    // SecureView
    SYS_INFO_TIMEZONE: "Timezone",
    TIMEZONE_HEADER: "Timezone",
    SELECT_TIMEZONE: "Select timezone for ThinVMs",
    TIMEZONE_DETAILS: "Timezone settings only apply to ThinVMs, this setting will not affect standard VMs.",
    BLANKER_HEADER: "Screen blanker",
    SET_BLANKER_TEXT: "Set screen blanker timeout to",
    DISABLE_BLANKER_TEXT: "Set to 0 to disable screen blanker"
})
